        ...
        <body>
            ...
            <main>
                ...
                if (count($user_datas) != 0) {
                    ...
                    $rented_movies_req_count = $conn->prepare('SELECT COUNT(*) AS nb_movies FROM catalogue AS catalogue JOIN movies_bookmark AS fav_movies ON catalogue.id = fav_movies.movie_id && fav_movies.user_id = ?');
                    ...
                    $fav_movies_req = $conn->prepare('SELECT DISTINCT catalogue.id, catalogue.movie_picture, catalogue.release_year, catalogue.title, catalogue.director FROM catalogue AS catalogue JOIN movies_bookmark AS fav_movies ON catalogue.id = fav_movies.movie_id && fav_movies.user_id = :id LIMIT :premier, :parpage;');
                    ...
                    ?>
                    <!-- BEGIN: Location favoris -->
                    <section id="fav_locations" class="container">
