        ...
        if($is_admin){
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 mt-3 mt-sm-3 mt-md-3 mt-lg-0 mt-xl-0 d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-md-inline d-sm-inline align-items-center justify-content-around align-items-center icon-right-nav text-md-end text-sm-end">
                    ...
                    <li class="nav-item h5"><a href="user_transaction.php?user_id='.$id_user.'" class="nav-link d-flex align-items-center justify-content-md-end justify-content-sm-end"><i class="p-2 icones_nav bx bxs-coin-stack" id="solde_icon"></i><span id="solde_value">'.$solde_user['solde'].'</span></a></li>
