...
!function (t) {
    ...
    return x.extend(!0, o.defaults, {
        ...
        function u(e, a) {
            for (var t, n, r = function (e) {
            ...
            }, s = 0, o = a.length; s < o; s++) if (n = a[s], Array.isArray(n)) u(e, n); else {
                switch (f = p = "", n) {
                    case"ellipsis":
                        p = "&#x2026;", f = "disabled";
                        break;
                ...
                p && (t = x("<li>", {
                    ...
                    class: "page-link"
                }).html(p)).appendTo(e), i.oApi._fnBindAction(t, {action: n}, r))
            }
        }

        var p, f, t, b = new o.Api(i), g = i.oClasses, m = i.oLanguage.oPaginate, w = i.oLanguage.oAria.paginate || {},
            e = x(e);
        try {
